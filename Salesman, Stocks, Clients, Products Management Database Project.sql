...
/*********************************/
/*Query 4 b : change the BalDue of ClientNo �C00001� to rs1000.*/
...
/*********************************/
/*Query 5 a : list the names of all client having �a� as the second letter in their names.*/

select name as client_name 
from client_master
where name like '_a%';

/*Query 5 b :  list the client who stay in a city whose first letter is �M�.*/

select name as client_name, city as client_city
from client_master
where city like 'M%';

/*Query 5 c : list all client who stay in �banglore� or �manglore�.*/
...
/*Query 5 f : list all the information for ClientNo �C00001� and �C00002�.*/
/*set operation*/
...
/*Query 5 i : list the name, city, stste of clients who are not in the state of �Maharastra�.*/
